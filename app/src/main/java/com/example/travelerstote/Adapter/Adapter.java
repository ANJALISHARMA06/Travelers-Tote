    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(view -> {
            ...
            if (adapterPosition != RecyclerView.NO_POSITION) {
                // Access data using the adapter position
                String clickedTitle = title.get(adapterPosition);
                // Use the clicked position and data as needed
                Intent intent = new Intent(view.getContext(), CheckList.class);
                intent.putExtra(MyConstants.HEADER_SMALL, clickedTitle);
                if (MyConstants.MY_SELECTIONS.equals(clickedTitle)) {
