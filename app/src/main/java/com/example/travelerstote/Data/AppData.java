package com.example.travelerstote.Data;

import android.app.Application;
import android.content.Context;
import android.widget.Toast;

import com.example.travelerstote.CheckList;
import com.example.travelerstote.Constants.MyConstants;
import com.example.travelerstote.Database.RoomDB;
import com.example.travelerstote.MainActivity;
...
public class AppData extends Application {
    ...
    public AppData(RoomDB database, MainActivity checkList) {
    ...
    public AppData(RoomDB database, CheckList checkList) {
    }
    ...
    public List<Items> getPersonalCareData() {
        ...
        String[] data = {"Tooth-brush", "Tooth-paste", "Floss", "Mouthwash",
                "Shaving Cream", "Razor Blade", "Soap", "Fiber", "Shampoo", "Hair Conditioner",
                "Brush", "Comb", "Hair Dryer", "Curling Iron", "Hair Moulder", "Hair Clip",
                "Moisturizer", "Lip Cream", "Contact Lens", "Perfume", "Deodorant",
                "Makeup Materials", "Makeup Remover", "Wet Wipes", "Pad", "Ear Stick", "Cotton",
                "Nail Polish", "Nail Polish Remover", "Tweezers", "Nail Scissors", "Nail Files",
                "Suntan Cream", "Rubber bands", "Facewash"};
    ...
    public List<Items> getClothingData() {
        ...
        String[] data = {"Stockings", "Underwear", "Pajamas", "T-Shirts", "Casual Dress",
    ...
    public List<Items> getBabyNeedsData() {
        ...
        String[] data = {"Sleep_suit", "Outfit", "Jumpsuit", "Baby Socks", "Baby Hat", "Baby Pyjamas",
                "Baby Bath Towel", "Muslin", "Blanket", "Baby Laundry Detergent",
                "Baby Bottles", "Baby Food Thermos", "Baby Bottle Brushes",
                "Brest-feeding Cover", "Breast Pump", "Water Bottle", "Storage Container",
                "Baby Food Spoon", "Ring-chairs", "Diaper", "Wet Wipes", "Baby Cotton", "Baby Care Cover",
                "Baby Shampoo", "Baby soap", "Baby Nail Scissors", "Body Moisturiser",
                "diaper Rash Cream", "Serum Physiological", "Nasal Aspirator", "Fly Repellent Lotion",
                "Pyrometer", "Antipyretic Syrup", "Probiotic Flowers", "Baby Backpack", "Stroller",
                "Baby Carrier", "Toys", "Playpen", "Baby Radio",
    ...
    public List<Items> getTechnologyData() {
        ...
        String[] data = {"Mobile Phone", "Phone Cover", "E-Book Reader", "Camera", "Camera Charger",
                ...
                "Flash-Light", "MP3 Player", "MP3 Player Charger", "Voltage Adapter", "3D Card"};
    ...
    public List<Items> getFoodData() {
        ...
        String[] data = {"Snack", "Sandwich", "Juice", "Tea Bags", "Coffee", "Water", "Thermos",
                "Chips", "Baby Food ", "chocolates"};
        return prepareItemsList(MyConstants.FOOD_CAMEL_CASE, data);
    }

    public List<Items> getBeachSuppliesData() {

        String[] data = {"Sea Cloths", "Suntan Cream", "Beach Umbrella", "Swim Fins",
                "Beach Bag", "Beach Towel", "Beach Slippers", "Sunbed", "Waterproof Clock"};
    ...
    public List<Items> getCarSuppliesData() {
        ...
        String[] data = {"Pump", "Car Jack", "Spare Car Key", "Accident Record Set",
                "Auto Refrigerator", "Car Cover", "Car Charger", "Window Sun Shades"};
    ...
    public List<Items> getNeedsData() {
        ...
        String[] data = {"Backpack", "Daily Bags", "Laundry Bag", "Sewing Kit", "Travel Lock",
                "Luggage Tag", "Magazine", "Sports Equipment", "Important Numbers", "Diary-Pen"};
