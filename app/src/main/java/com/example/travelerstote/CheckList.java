...
import static com.example.travelerstote.R.id.txtAdd;
...
import com.example.travelerstote.Adapter.CheckListAdepter;
...
public class CheckList extends AppCompatActivity {
    ...
    CheckListAdepter checkListAdepter;
    RoomDB database;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.btnMySelections) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Are you sure?\n\nAs this will delete the data provided by (Travelers Tote) while installing.")
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Are you sure?\n\nAs this will load the default data provided by (Travelers Tote) " +
    ...
    private void addNEWItem(String itemName){
        ...
        itemsList = database.mainDao().getAll(header);
        updateRecycler(itemsList);
        recyclerView.scrollToPosition(checkListAdepter.getItemCount()-1);
        txtAdd.setText("");
    }
    private void updateRecycler(List<Items> itemsList){
        ...
        checkListAdepter = new CheckListAdepter(CheckList.this,itemsList,database,show);
        recyclerView.setAdapter(checkListAdepter);
